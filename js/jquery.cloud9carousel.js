...
(function($) {
  ...
  var Item = function( element, options ) {
    ...
    this.moveTo = function( x, y, scale ) {
      ...
      style.zIndex = "" + (scale * 100) | 0;
		...
		//ADD BLURR
		//  var filterVal = 'blur('+((y*0.1)/(scale*4.5))+'px)';
		  var brightVal = ' brightness('+(scale*100)+'%)';
	  //  $(element).css('webkitFilter',filterVal+ brightVal);
	   $(element).css('webkitFilter',brightVal);
	   $(element).css('opacity', (scale)*1);
  ...
  var Carousel = function( element, options ) {
    ...
    this.xOrigin =  $container.width()  * 0.5 ;
    this.yOrigin = $container.height() * 0.1 ;
...
self.play();
    ...
    this.nearestItem = function() {
		var itemLove = this.items[this.nearestIndex()];
      return itemLove;
